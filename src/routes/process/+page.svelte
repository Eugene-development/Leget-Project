...
<PageIntro eyebrow="Начало работы" title="Алгоритм настройки сайта">
	<p>
		На этой странице описан пошаговый процесс настройки нового сайта после оформления подписки. Следуйте инструкциям, чтобы ваш проект был готов к работе в кратчайшие сроки.
	</p>
</PageIntro>
				...
				<FadeIn>
					...
					<div class="mt-6">
						...
						<TagList class="mt-4">
							...
							<TagListItem>Контакты</TagListItem>
							<TagListItem>Ассортимент</TagListItem>
							<TagListItem>Акции</TagListItem>
