...
<Container class="mt-24 sm:mt-32 md:mt-56">
	<FadeIn class="max-w-3xl">
		...
		<p class="mt-6 text-xl text-neutral-600">
			Готовые сайты для мебельного бизнеса от компании <span class="text-neutral-900 font-bold">Léget</span>.
			Выберите готовый вариант и мы запустим его для вас за 72 часа на вашем домене.
		</p>
		...
		<p class="mt-2 text-xl text-neutral-600">
			Стоимость подписки на сайт <span class="text-neutral-900">от 160 рублей</span> в день.
		</p>
		<!-- <p class="mt-6 text-xl text-neutral-600">
