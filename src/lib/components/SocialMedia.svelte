...
<ul
	role="list"
	class="flex gap-x-10 {invert ? 'text-white' : 'text-neutral-950'} {className}"
>
	{#each socialMediaProfiles as profile}
		<li>
			...
			>
				...
				{:else if profile.icon === 'instagram'}
					<svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 fill-current">
						<path
							fill-rule="evenodd"
							clip-rule="evenodd"
